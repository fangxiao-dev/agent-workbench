...
| openaiDeveloperDocs | Codex MCP server | OpenAI Developer Docs MCP | 在 Codex 配置 `mcp_servers.openaiDeveloperDocs.url = "https://developers.openai.com/mcp"` | `~/.codex/config.toml` | ⬜ 未装 | 这是 Codex 侧的第三方集成，不属于本仓库自建内容 |
