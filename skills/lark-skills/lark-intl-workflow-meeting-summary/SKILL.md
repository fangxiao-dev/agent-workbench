...
**CRITICAL — 开始前 MUST 先用 Read 工具读取 [`../lark-intl-shared/SKILL.md`](../lark-intl-shared/SKILL.md)，其中包含认证、权限处理**。然后阅读 [`../lark-intl-vc/SKILL.md`](../lark-intl-vc/SKILL.md)，了解会议纪要相关操作。
...
阅读 [`../lark-intl-doc/SKILL.md`](../lark-intl-doc/SKILL.md) 学习云文档技能。
...
- [lark-intl-shared](../lark-intl-shared/SKILL.md) — 认证、权限（必读）
- [lark-vc](../lark-intl-vc/SKILL.md) — `+search`、`+notes` 详细用法
- [lark-intl-doc](../lark-intl-doc/SKILL.md) — `+fetch`、`+create`、`+update` 详细用法
