...
> **前置条件：** 先阅读 [`../lark-intl-shared/SKILL.md`](../lark-intl-shared/SKILL.md) 了解认证、身份切换和安全规则。
...
- [lark-intl-skill-maker](../lark-intl-skill-maker/SKILL.md) — 如需将挖掘到的 API 固化为新 Skill
