---
name: lark-intl-workflow-standup-report
version: 1.0.0
...
- [lark-calendar](../lark-intl-calendar/SUB-SKILL.md) — `+agenda` 详细用法
- [lark-task](../lark-intl-task/SUB-SKILL.md) — `+get-my-tasks` 详细用法
