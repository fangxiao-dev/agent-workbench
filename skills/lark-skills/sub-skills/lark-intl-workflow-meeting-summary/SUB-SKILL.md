---
name: lark-intl-workflow-meeting-summary
version: 1.0.0
...
**CRITICAL — 开始前 MUST 先用 Read 工具读取 [`../lark-intl-shared/SUB-SKILL.md`](../lark-intl-shared/SUB-SKILL.md)，其中包含认证、权限处理**。然后阅读 [`../lark-intl-vc/SUB-SKILL.md`](../lark-intl-vc/SUB-SKILL.md)，了解会议纪要相关操作。
...
阅读 [`../lark-intl-doc/SUB-SKILL.md`](../lark-intl-doc/SUB-SKILL.md) 学习云文档技能。
...
- [lark-intl-shared](../lark-intl-shared/SUB-SKILL.md) — 认证、权限（必读）
- [lark-vc](../lark-intl-vc/SUB-SKILL.md) — `+search`、`+notes` 详细用法
- [lark-intl-doc](../lark-intl-doc/SUB-SKILL.md) — `+fetch`、`+create`、`+update` 详细用法
