...
> 上传需要Lark认证。遇到认证或权限错误时，阅读 [`../lark-intl-shared/SKILL.md`](../lark-intl-shared/SKILL.md) 了解登录和权限处理。
...
关于Lark文档的创建，读取等更多操作，请参考 lark-intl-doc skill [`../lark-intl-doc/SKILL.md`](../lark-intl-doc/SKILL.md)。
