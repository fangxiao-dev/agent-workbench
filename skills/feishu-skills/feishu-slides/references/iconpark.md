...
```bash
python3 skills/feishu-slides/scripts/iconpark_tool.py search --query "增长趋势" --limit 8
python3 skills/feishu-slides/scripts/iconpark_tool.py resolve --name chart-line
python3 skills/feishu-slides/scripts/iconpark_tool.py list-categories
```
