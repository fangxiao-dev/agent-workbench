# feishu-slides xml_presentation.slide get
...
- [slides +replace-slide](feishu-slides-replace-slide.md) — 块级替换 shortcut（推荐）
- [xml_presentation.slide replace](feishu-slides-xml-presentation-slide-replace.md) — 底层 replace API 参考
- [xml_presentations get](feishu-slides-xml-presentations-get.md) — 读整个 PPT
- [feishu-slides-edit-workflows.md](feishu-slides-edit-workflows.md) — 读-改-写闭环
