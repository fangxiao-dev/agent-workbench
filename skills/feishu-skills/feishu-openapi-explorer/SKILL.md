...
> **前置条件：** 先阅读 [`../feishu-shared/SKILL.md`](../feishu-shared/SKILL.md) 了解认证、身份切换和安全规则。
...
- [feishu-skill-maker](../feishu-skill-maker/SKILL.md) — 如需将挖掘到的 API 固化为新 Skill
