...
每个 `messages[]` 项使用与 [`mail +message`](./feishu-mail-message.md#返回值) 相同的结构。完整字段列表参见 [`+message` 字段说明](./feishu-mail-message.md#字段说明) 和 [`+message` security_level](./feishu-mail-message.md#security_level)。
