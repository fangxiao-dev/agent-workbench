...
- [feishu-minutes](../SKILL.md) -- 妙记相关命令
- [feishu-vc-notes](../../feishu-vc/references/feishu-vc-notes.md) -- 基于 `minute_token` 获取逐字稿、总结、待办、章节等产物
- [feishu-shared](../../feishu-shared/SKILL.md) -- 认证和全局参数
- [feishu-vc](../../feishu-vc/SKILL.md) -- 视频会议全部命令
