...
- 如需获取妙记的纪要内容（逐字稿、AI 总结等），请使用 [vc +notes](../../feishu-vc/references/feishu-vc-notes.md)。

## 参考

- [feishu-minutes](../SKILL.md) — 妙记全部命令
- [feishu-vc-notes](../../feishu-vc/references/feishu-vc-notes.md) — 会议纪要查询
