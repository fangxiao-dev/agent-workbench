...
如果用户要“改会议时间”“换会议室”“给现有日程加会议室”，必须先阅读 [`feishu-calendar-schedule-meeting.md`](feishu-calendar-schedule-meeting.md) 并按其中工作流处理：
...
- [feishu-calendar](../SKILL.md) -- 日历全部命令
- [feishu-shared](../../feishu-shared/SKILL.md) -- 认证和全局参数
- [feishu-calendar-schedule-meeting](feishu-calendar-schedule-meeting.md) -- 预约/改约会议与会议室工作流
- [feishu-calendar-room-find](feishu-calendar-room-find.md) -- 查找可用会议室
- [feishu-calendar-freebusy](feishu-calendar-freebusy.md) -- 查询忙闲
