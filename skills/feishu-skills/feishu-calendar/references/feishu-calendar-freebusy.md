...
> **前置条件：** 先阅读 [`../feishu-shared/SKILL.md`](../../feishu-shared/SKILL.md)。
...
- [feishu-calendar-agenda](feishu-calendar-agenda.md) — 查看日程安排
- [feishu-calendar-create](feishu-calendar-create.md) — 创建日程
- [feishu-calendar-suggestion](feishu-calendar-suggestion.md) — 根据非明确时间或一段时间范围，推荐多个可用时间块方案
- [feishu-calendar](../SKILL.md) — 日历完整 API
