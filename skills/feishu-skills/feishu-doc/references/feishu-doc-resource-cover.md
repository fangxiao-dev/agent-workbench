...
- 用户要下载正文图片、附件、画板缩略图：继续使用 [`docs +media-download`](feishu-doc-media-download.md)
...
- [feishu-doc-media-download](feishu-doc-media-download.md) — 下载正文素材或画板缩略图
- [feishu-doc-media-insert](feishu-doc-media-insert.md) — 在正文插入图片/文件
