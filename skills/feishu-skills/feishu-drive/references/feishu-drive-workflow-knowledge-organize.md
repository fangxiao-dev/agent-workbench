...
Before running this workflow, MUST read [`../../feishu-shared/SKILL.md`](../../feishu-shared/SKILL.md) for identity, authentication, permission handling, and write-operation confirmation rules.

Load other skills / references progressively:

- Wiki / personal library target: [`../../feishu-wiki/SKILL.md`](../../feishu-wiki/SKILL.md)
- Content read required: [`../../feishu-doc/SKILL.md`](../../feishu-doc/SKILL.md) and [`../../feishu-doc/references/feishu-doc-fetch.md`](../../feishu-doc/references/feishu-doc-fetch.md)
- Sheet down-drill required: [`../../feishu-sheets/SKILL.md`](../../feishu-sheets/SKILL.md)
- Base down-drill required: [`../../feishu-base/SKILL.md`](../../feishu-base/SKILL.md)
...
|------|------|--------------|
| `feishu-drive-workflow-knowledge-organize.md` | Workflow trigger, global contract, state machine, progressive load map, command family allowlist | Stage-specific rules, output templates, execution details |
| `feishu-drive-workflow-knowledge-organize-discovery.md` | `PARSE_SCOPE`, `INVENTORY`, target parsing, stop conditions, inventory limits, `ResourceItem` | Classification, plan generation, write execution |
| `feishu-drive-workflow-knowledge-organize-analysis.md` | `CONTENT_READ`, `ISSUE_ANALYSIS`, `RULE_GENERATION`, low-confidence reads, issue rules, problem pagination, classification, target tree | Plan execution, write confirmation, verification |
| `feishu-drive-workflow-knowledge-organize-planning.md` | `PLAN_GENERATION`, `EXEC_CONFIRM`, `PlanItem`, `DisplayItem`, plan pagination, plan revision, execution scope confirmation | Scope parsing, resource inventory, write execution, verification |
| `feishu-drive-workflow-knowledge-organize-execution.md` | `EXECUTE`, `VERIFY`, `PathTokenMap`, write execution, progress reporting, verification, next suggestions, internal recovery hooks | Scope parsing, resource inventory, classification, plan generation, plan revision, rollback execution details |
| `feishu-drive-workflow-knowledge-organize-rollback.md` | `ROLLBACK_CONFIRM`, `ROLLBACK`, `ROLLBACK_VERIFY`, `ROLLBACK_CLEANUP_CONFIRM`, `ROLLBACK_CLEANUP`, `ROLLBACK_CLEANUP_VERIFY`, recovery plan generation, recovery execution, cleanup verification | Scope parsing, resource inventory, classification, organization plan generation, normal write execution |
...
|-------|---------------------|
| `PARSE_SCOPE` | [`feishu-drive-workflow-knowledge-organize-discovery.md`](feishu-drive-workflow-knowledge-organize-discovery.md) |
| `INVENTORY` | [`feishu-drive-workflow-knowledge-organize-discovery.md`](feishu-drive-workflow-knowledge-organize-discovery.md) |
| `CONTENT_READ` | [`feishu-drive-workflow-knowledge-organize-analysis.md`](feishu-drive-workflow-knowledge-organize-analysis.md) |
| `ISSUE_ANALYSIS` | [`feishu-drive-workflow-knowledge-organize-analysis.md`](feishu-drive-workflow-knowledge-organize-analysis.md) |
| `RULE_GENERATION` | [`feishu-drive-workflow-knowledge-organize-analysis.md`](feishu-drive-workflow-knowledge-organize-analysis.md) |
| `PLAN_GENERATION` | [`feishu-drive-workflow-knowledge-organize-planning.md`](feishu-drive-workflow-knowledge-organize-planning.md) |
| `EXEC_CONFIRM` | [`feishu-drive-workflow-knowledge-organize-planning.md`](feishu-drive-workflow-knowledge-organize-planning.md) |
| `EXECUTE` | [`feishu-drive-workflow-knowledge-organize-execution.md`](feishu-drive-workflow-knowledge-organize-execution.md) |
| `VERIFY` | [`feishu-drive-workflow-knowledge-organize-execution.md`](feishu-drive-workflow-knowledge-organize-execution.md) |
| `ROLLBACK_CONFIRM` | [`feishu-drive-workflow-knowledge-organize-rollback.md`](feishu-drive-workflow-knowledge-organize-rollback.md) |
| `ROLLBACK` | [`feishu-drive-workflow-knowledge-organize-rollback.md`](feishu-drive-workflow-knowledge-organize-rollback.md) |
| `ROLLBACK_VERIFY` | [`feishu-drive-workflow-knowledge-organize-rollback.md`](feishu-drive-workflow-knowledge-organize-rollback.md) |
| `ROLLBACK_CLEANUP_CONFIRM` | [`feishu-drive-workflow-knowledge-organize-rollback.md`](feishu-drive-workflow-knowledge-organize-rollback.md) |
| `ROLLBACK_CLEANUP` | [`feishu-drive-workflow-knowledge-organize-rollback.md`](feishu-drive-workflow-knowledge-organize-rollback.md) |
| `ROLLBACK_CLEANUP_VERIFY` | [`feishu-drive-workflow-knowledge-organize-rollback.md`](feishu-drive-workflow-knowledge-organize-rollback.md) |
...
| `CONTENT_READ` | `docs +fetch`, plus `feishu-sheets` / `feishu-base` when conditionally required | Partial content read for low-confidence items |
...
2. If auth or API scope is missing, follow `feishu-shared` permission handling and stop.
...
- [Discovery phase](feishu-drive-workflow-knowledge-organize-discovery.md)
- [Analysis phase](feishu-drive-workflow-knowledge-organize-analysis.md)
- [Planning phase](feishu-drive-workflow-knowledge-organize-planning.md)
- [Execution phase](feishu-drive-workflow-knowledge-organize-execution.md)
- [Rollback phase](feishu-drive-workflow-knowledge-organize-rollback.md)
- [feishu-shared](../../feishu-shared/SKILL.md)
- [feishu-drive](../SKILL.md)
- [feishu-drive-files-list](feishu-drive-files-list.md)
- [feishu-drive-search](feishu-drive-search.md)
- [feishu-drive-inspect](feishu-drive-inspect.md)
- [feishu-drive-apply-permission](feishu-drive-apply-permission.md)
- [feishu-drive-task-result](feishu-drive-task-result.md)
- [feishu-drive-delete](feishu-drive-delete.md)
- [feishu-wiki](../../feishu-wiki/SKILL.md)
- [feishu-wiki-node-delete](../../feishu-wiki/references/feishu-wiki-node-delete.md)
- [feishu-doc](../../feishu-doc/SKILL.md)
- [feishu-doc-fetch](../../feishu-doc/references/feishu-doc-fetch.md)
