...
1. Follow [`../../feishu-shared/SKILL.md`](../../feishu-shared/SKILL.md) for identity, auth, and permission handling.
2. For Wiki / personal library targets, follow [`../../feishu-wiki/SKILL.md`](../../feishu-wiki/SKILL.md).
3. For Drive folder inventory, follow [`feishu-drive-files-list.md`](feishu-drive-files-list.md).
4. For Drive search targets, follow [`feishu-drive-search.md`](feishu-drive-search.md).
5. For URL / token inspection, follow [`feishu-drive-inspect.md`](feishu-drive-inspect.md) and [`../../feishu-wiki/references/feishu-wiki-node-get.md`](../../feishu-wiki/references/feishu-wiki-node-get.md).
...
| Input is real keyword / name | Search with the real keyword according to `feishu-drive-search` | Search scope | `INVENTORY` after user confirms scope |
| Input is range browsing / statistical description with no real keyword | Search by filters / empty-query browsing according to `feishu-drive-search` | Search scope | `INVENTORY` after user confirms scope |
...
|-------|---------------------------|-----------------------|
| Wiki recursion | `max_depth=3`, `max_items=500`; follow `feishu-wiki-node-list` pagination | Record queued nodes / paths in `inventory_continuation_state` and immediately continue the next internal batch within the confirmed scope unless blocked |
...
1. Follow [`../../feishu-wiki/references/feishu-wiki-node-list.md`](../../feishu-wiki/references/feishu-wiki-node-list.md) traversal semantics.
...
1. Use `drive files list` according to [`feishu-drive-files-list.md`](feishu-drive-files-list.md); its schema path is `drive.files.list`.
...
| Missing API scope | Follow `feishu-shared` permission handling and stop | Do not retry the same command repeatedly |
