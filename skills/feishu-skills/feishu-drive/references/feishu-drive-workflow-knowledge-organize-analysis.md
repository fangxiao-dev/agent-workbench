...
1. `resource_items` MUST already exist from [`feishu-drive-workflow-knowledge-organize-discovery.md`](feishu-drive-workflow-knowledge-organize-discovery.md).
2. For document partial reads, follow [`../../feishu-doc/SKILL.md`](../../feishu-doc/SKILL.md) and [`../../feishu-doc/references/feishu-doc-fetch.md`](../../feishu-doc/references/feishu-doc-fetch.md).
3. For sheet / bitable down-drill, follow [`../../feishu-sheets/SKILL.md`](../../feishu-sheets/SKILL.md) or [`../../feishu-base/SKILL.md`](../../feishu-base/SKILL.md) only when title and path are insufficient.
...
3. Read only supported docs through `feishu-doc-fetch`.
4. Switch to `feishu-sheets` / `feishu-base` only when sheet / bitable title and path are insufficient.
...
| Resource is low-confidence and docs-fetch-supported | Read outline via `feishu-doc-fetch` | Do not skip partial read |
...
| Partial read returns usable block id and classification is still unclear | Read the relevant section via `feishu-doc-fetch` | Do not read the full document |
