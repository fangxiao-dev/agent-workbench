...
> 前置条件：通用认证、scope 与 `--as` 规则见 [`../../feishu-shared/SKILL.md`](../../feishu-shared/SKILL.md)。
...
如果用户只是想向文档 owner 申请访问权限，优先使用 [`feishu-drive-apply-permission.md`](feishu-drive-apply-permission.md)。
