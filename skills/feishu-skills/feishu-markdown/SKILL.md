...
- 用户要先拿 Markdown 文件的历史版本号，再做比较/下载/回滚，先用 [`feishu-drive`](../feishu-drive/SKILL.md) 的 `lark-cli drive +version-history`
- 用户要把本地 Markdown **导入成在线新版文档（docx）**，不要用本 skill，改用 [`feishu-drive`](../feishu-drive/SKILL.md) 的 `lark-cli drive +import --type docx`
- 用户要对 Markdown 文件做**rename / move / delete / 搜索 / 权限 / 评论**等云空间（云盘/云存储）操作，不要留在本 skill，切到 [`feishu-drive`](../feishu-drive/SKILL.md)
...
| Shortcut | 说明 |
|----------|------|
| [`+create`](references/feishu-markdown-create.md) | Create a Markdown file in Drive |
| [`+diff`](references/feishu-markdown-diff.md) | Compare two remote Markdown versions, or compare remote Markdown against a local file |
| [`+fetch`](references/feishu-markdown-fetch.md) | Fetch a Markdown file from Drive |
| [`+patch`](references/feishu-markdown-patch.md) | Patch a Markdown file in Drive via fetch-local-replace-overwrite |
| [`+overwrite`](references/feishu-markdown-overwrite.md) | Overwrite an existing Markdown file in Drive |

## 参考

- [feishu-shared](../feishu-shared/SKILL.md) — 认证和全局参数
- [feishu-drive](../feishu-drive/SKILL.md) — Drive 文件管理、导入 docx、move/delete/search 等
