...
When the user refers to a chat by name and you need its `chat_id` for the `--chat-id` filter, use [`+chat-search`](feishu-im-chat-search.md) first:
...
- [feishu-im-threads-messages-list](feishu-im-threads-messages-list.md) - inspect thread replies
