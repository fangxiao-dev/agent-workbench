...
`chat_name` resolution always runs, so there is no single-scope, un-enriched path. For the other raw `feed.groups.*` methods, see [feishu-im-feed-groups.md](feishu-im-feed-groups.md).
...
- [feishu-im-feed-groups.md](feishu-im-feed-groups.md) — raw `feed.groups.*` APIs, enums, and rule guidance
- [feishu-im-feed-group-list.md](feishu-im-feed-group-list.md) — list your feed groups
- [feishu-im-feed-group-list-item.md](feishu-im-feed-group-list-item.md) — list all feed cards in a group (paginated)
