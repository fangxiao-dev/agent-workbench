...
- To inspect the current shortcut list, use [`+feed-shortcut-list`](feishu-im-feed-shortcut-list.md). To remove a shortcut, use [`+feed-shortcut-remove`](feishu-im-feed-shortcut-remove.md).
