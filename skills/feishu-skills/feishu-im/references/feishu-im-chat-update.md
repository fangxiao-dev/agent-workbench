...
Identity choice should follow [Group Chat Identity Rules](feishu-im-chat-identity.md): if the user explicitly specifies an identity, use it directly; otherwise infer the owner identity from context.
