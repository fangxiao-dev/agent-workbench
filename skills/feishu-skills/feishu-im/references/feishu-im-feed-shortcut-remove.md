...
> **Prerequisite:** Read [`../feishu-shared/SKILL.md`](../../feishu-shared/SKILL.md) for authentication, global parameters, and security rules.
...
- To see what is currently in the shortcut list before removing, run [`+feed-shortcut-list`](feishu-im-feed-shortcut-list.md). Use `--no-detail` when you only need the `feed_card_id` values.
