...
> **Prerequisites:** Please read `../feishu-shared/SKILL.md` to understand authentication, global parameters, and security rules.
...
- [feishu-task](../SKILL.md) -- All task commands
