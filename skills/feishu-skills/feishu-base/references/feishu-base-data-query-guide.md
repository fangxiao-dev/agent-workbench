...
This guide is the entry point for `+data-query`. Use it for common aggregation fewshots and command selection. For the complete DSL fields, operators, limits, and response details, use [feishu-base-data-query.md](feishu-base-data-query.md) as the DSL SSOT.

Before using `+data-query`, also follow [feishu-base-data-analysis-sop.md](feishu-base-data-analysis-sop.md) to confirm that the task really needs aggregation instead of record listing or a temporary view.
...
Read [feishu-base-data-query.md](feishu-base-data-query.md) when you need:
