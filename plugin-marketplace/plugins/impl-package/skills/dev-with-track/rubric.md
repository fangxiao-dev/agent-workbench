...
- [已确认] `$dispatcher` 与 `/impl-package:subagent-driven-development` 是平级指导：前者面向上游 baby-step admission、dispatch/return/idle，后者面向下游 bounded worker 的 Topic/dependency/mode/lane/lifecycle；本 Skill 选择业务动作并消费两者结果。
